...
const VOCAB_EXAMPLES={
  ...
  colores:[
    ["El carro es rojo.","The car is red."],["El carro es azul.","The car is blue."],["El carro es verde.","The car is green."],["El carro es amarillo.","The car is yellow."],["El carro es naranja.","The car is orange."],["El carro es rosado.","The car is pink."],["El carro es morado.","The car is purple."],["El carro es blanco.","The car is white."],["El carro es negro.","The car is black."],["El carro es café.","The car is brown."],["El carro es gris.","The car is gray."]
  ],
  dias:[
  ...
  cuerpo:[
    ["Me duele la cabeza.","My head hurts."],["Me duele el ojo.","My eye hurts."],["Me duele la oreja.","My ear hurts."],["Tengo la nariz fría.","My nose is cold."],["Abre la boca, por favor.","Open your mouth, please."],["Me duele el cuello.","My neck hurts."],["Me duele el hombro.","My shoulder hurts."],["Me duele el brazo.","My arm hurts."],["Me lavo las manos.","I wash my hands."],["Me corté un dedo.","I cut a finger."],["Me duele la pierna.","My leg hurts."],["Me duele el pie.","My foot hurts."],["Mi corazón late rápido.","My heart is beating fast."],["Me duele el estómago.","My stomach hurts."],["Me duele la espalda.","My back hurts."]
  ],
  comida:[
